...
const About = () => {
  return (
    <div name='about' className='w-full h-screen text-black'>
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col content-center justify-center w-full h-full ml-30 mr-30'>
        <div className='pb-8'>
        ...
        <div>
          <p className='text-xl mt-20 '>
            ...
            performance of the top PGA players. The back-end is built with REST
